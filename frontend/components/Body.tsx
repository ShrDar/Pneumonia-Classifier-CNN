        ...
        <div className="grid gap-10 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-zinc-700 bg-zinc-800 p-5 text-white">
                ...
                <div className="mt-4 rounded-lg bg-[#1a1a1ab4] p-3 max-h-[20vh] overflow-y-scroll lg:overflow-auto">
                  <p className="text-sm leading-6 text-">
                    ...
                    and research purposes only. It is <strong>not</strong> a medical
          ...
          <div>
            <div
              ...
              className="relative flex h-80 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl border-2 border-zinc-700 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black transition-all hover:border-zinc-500"
            >
              {!preview && (
                <>
                  <Image
